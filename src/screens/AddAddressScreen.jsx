...
const AddAddressScreen = ({setModalVisible}) => {
  ...
  return (
    <View className="flex-1 justify-start items-center bg-white mt-10">
      <View className="w-full p-5">
        ...
        <View className="flex-row justify-between mb-4">
          ...
          <Pressable
            ...
            onPress={() =>
              dispatch(updateAddressForm({addressType: 'Office'}))
            }>
        ...
        <TextInput
          ...
          onChangeText={text =>
            dispatch(updateAddressForm({receiverName: text}))
          }
        />
        <TextInput
          className="w-full border border-gray-300 rounded-lg p-2 mb-2"
        ...
        <TextInput
          ...
          onChangeText={text =>
            dispatch(updateAddressForm({phoneNumber: text}))
          }
